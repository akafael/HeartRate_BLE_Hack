...
public class DeviceActivity extends ViewPagerActivity
{
	...
	protected void onResume() {
		Log.d(TAG, "onResume");
		super.onResume();
	//We need to do register the receiver
	//Since we need to receive the message that is broadcasted
	...
	protected void onPause() {
		Log.d(TAG, "onPause");
		super.onPause();
	//We need to do unregister the receiver
	//If the app is paused, we don't want it to keep broadcasting
	//the message
	...
	void onDeviceViewReady(View view) 
	{
		...
		// Create GATT object 
		//In order to access each of the services 
	...
	//This function displays all of the services
	private void displayServices() {
		...
		if (mServicesRdy) {
			...
			mDeviceView.setStatus(n + " services+ShibyISawesome");
			mDeviceView.notifyDataSetChanged();
		} else {
			setError("Failed to read services");
		}
	}
//In this function the Service Activity is called via an intent
//To display the selected service
